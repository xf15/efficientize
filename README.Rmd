...
* todo 
  * replace current esl examples with more scientific ones, or not, don't think i would make this package were i native speaker 
  * dict_psyexp.csv is there, not add added to create_dict.r, data.r, or tested yet 
...
consistent function documentation among readme, writing_help.rmd, writing_help.r 
